...
import { ActivityIndicator, Alert, Image, KeyboardAvoidingView, Platform, Pressable, StatusBar, Text, TextInput, View } from "react-native";
    ...
    <View style={{ flex: 1, backgroundColor: "#000" }}>
      ...
      >
        ...
        <Animated.View entering={SlideInUp.delay(500).duration(800)} style={{ alignItems: "center", marginTop: 40 }}>
          <Text style={{ color: "#8E8E93", fontWeight: "600" }}>Developed by Codex Infotech</Text>
        </Animated.View>
